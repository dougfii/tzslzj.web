...
class MailHelpCls
{
    public static function sendForget($email, $title, $href)
    {
        ...
        $cont .= '<p>' . $href . '</p><br/><br/>';
        $cont .= "<p>感谢您使用泰州水利工程质量监督管理站网站！  系统邮件，请勿回复</p>";
...
<body>
<div class="m">
<div class="n">泰州水利工程质量监督管理站  <a href="http://www.xzslzj.cn">ZXSLZJ.CN</a></div>
<div class="h">' . $title . '</div>
<div class="c">' . $content . '</div>
<div class="f">Copyright © 泰州水利工程质量监督管理站 2016-2017 All Right Reserved.</div>
</div>
</body>
</html>
		';
